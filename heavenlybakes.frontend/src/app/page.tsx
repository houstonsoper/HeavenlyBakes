    ...
    return (
        <main>
            <div className="flex flex-col min-h-screen">
                ...
                <PageHeader title="About Us" description="At Heavenly Bakes, we've been crafting delicious bakes for over 20 years. Our passion
                            for baking and commitment to quality ingredients make our bakes truly special."/>
                ...
                <section id="contact" className="py-20">
                    <div className="container mx-auto px-4">
                        ...
                        <form className="max-w-md mx-auto">
                            ...
                            <Button type="submit" className="bg-pink-500 hover:bg-pink-600 text-white w-full">Send
                                Message</Button>
                        </form>
                    </div>
                </section>
