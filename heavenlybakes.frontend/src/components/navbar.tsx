                ...
                <nav>
                    <ul className="flex space-x-4">
                        ...
                        {user ? (
                            ...
                            <li><Link href="/api/auth/logout" className="text-pink-600 hover:text-pink-800">Logout</Link></li>
                        ) : <li><Link href="/api/auth/login" className="text-pink-600 hover:text-pink-800">Login</Link></li>
                        }
                        <BasketCount/>
                    </ul>
                </nav>
